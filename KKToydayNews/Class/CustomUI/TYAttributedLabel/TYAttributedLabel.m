...
- (void)setTextContainer:(TYTextContainer *)attStringCreater
{
    ...
    _preferredMaxLayoutWidth = attStringCreater.attriTextWidth;
...
- (void)drawRect:(CGRect)rect {
    ...
    switch (_verticalAlignment) {
        case TYVerticalAlignmentCenter:
            verticalOffset = MAX(0, (CGRectGetHeight(rect) - _textContainer.attriTextHeight)/2);
            break;
        case TYVerticalAlignmentBottom:
            verticalOffset = MAX(0, (CGRectGetHeight(rect) - _textContainer.attriTextHeight));
            break;
        default:
            break;
    }

    CGFloat contextHeight = MAX(CGRectGetHeight(self.bounds) , _textContainer.attriTextHeight);
...
- (CGPoint)covertTapPiont:(CGPoint)piont {
    ...
    switch (_verticalAlignment) {
        case TYVerticalAlignmentCenter:
            verticalOffset = MAX(0, (CGRectGetHeight(self.frame) - _textContainer.attriTextHeight)/2);
            break;
        case TYVerticalAlignmentBottom:
            verticalOffset = MAX(0, (CGRectGetHeight(self.frame) - _textContainer.attriTextHeight));
            break;
        default:
            break;
    }
