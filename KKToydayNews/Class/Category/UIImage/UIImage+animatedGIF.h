...
*/
+ (UIImage *)animatedImageWithAnimatedGIFData:(NSData *)theData scaleFactor:(float)scaleFactor quality:(CGFloat)compressionQuality ;
...
*/
+ (UIImage *)animatedImageWithAnimatedGIFURL:(NSURL *)theURL scaleFactor:(float)scaleFactor quality:(CGFloat)compressionQuality;
